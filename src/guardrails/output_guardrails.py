...
def content_filter(response: str) -> dict:
    ...
    PII_PATTERNS = {
        ...
        "connection_string": r"(postgres|mysql|mongodb|db\.)[\w\-.:/]+",
    }
    ...
    async def after_model_callback(
        ...
        *,
        ...
        if not filter_result["safe"]:
            ...
            llm_response.content.parts = [types.Part.from_text(text=redacted)]
        ...
        if self.use_llm_judge:
            ...
            if not judge_result.get("safe", True):
                llm_response.content.parts = [
                    types.Part.from_text(text="I cannot provide that response because it may be unsafe or hallucinated.")
                ]
